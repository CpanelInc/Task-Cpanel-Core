...
Task::Cpanel::Core - The great new Task::Cpanel::Core!
...
the web interface at L<http://rt.cpan.org/NoAuth/ReportBug.html?Queue=Task-Cpanel-Core>.  I will be notified, and then you'll
...
L<http://search.cpan.org/dist/Task-Cpanel-Core/>
